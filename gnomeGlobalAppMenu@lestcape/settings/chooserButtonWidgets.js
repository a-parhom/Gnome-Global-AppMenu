...
/*const BaseChooserButton = new GObject.Class({
    ...
    Extends: Gtk.Button,*/
const BaseChooserButton = GObject.registerClass({
...
const PictureChooserButton = GObject.registerClass({    
    ...
    class PictureChooserButton extends BaseChooserButton {
        ...
        on_after_draw(widget, cr, data) { //data=null
        ...
        increment_loading_progress(inc) {
        ...
        _on_picture_selected(menuitem, path, callback, id) {//id=null
            let result = null;
            if (id != null) {
        ...
        add_picture(path, callback, title, id) {//title=null, id=null
            if (Gio.file_new_for_path(path).query_exists(null)) {
                let pixbuf;
...
/*const DateChooserButton = new GObject.Class({
    ...
    Extends: Gtk.Button,*/
const DateChooserButton = GObject.registerClass({    
...
const EffectMenuItem = GObject.registerClass({    
...
const EffectMenuItemnone = GObject.registerClass({    
...
/*const EffectMenuItemscale = new GObject.Class({
    ...
    Extends: EffectMenuItem,*/
const EffectMenuItemscale = GObject.registerClass({    
    ...
    class EffectMenuItemscale extends EffectMenuItem {
        ...
        animate(context, x, y, percent_complete, color) {
...
/*const fade = new GObject.Class({
    ...
    Extends: EffectMenuItem,*/
const fade = GObject.registerClass({
...
/*const EffectMenuItemblend = new GObject.Class({
    ...
    Extends: EffectMenuItem,*/
const EffectMenuItemblend = GObject.registerClass({    
...
/*const EffectMenuItemtraditional = new GObject.Class({
    ...
    Extends: EffectMenuItem,*/
const EffectMenuItemtraditional = GObject.registerClass({    
...
/*const EffectMenuItemmove = new GObject.Class({
    ...
    Extends: EffectMenuItem,*/
const EffectMenuItemmove = GObject.registerClass({
...
/*const EffectMenuItemflyUp = new GObject.Class({
    ...
    Extends: EffectMenuItem,*/
const EffectMenuItemflyUp = GObject.registerClass({
...
/*const EffectMenuItemflyDown = new GObject.Class({
    ...
    Extends: EffectMenuItem,*/
const EffectMenuItemflyDown = GObject.registerClass({    
...
/*const TweenChooserButton = new GObject.Class({
    ...
    Extends: BaseChooserButton,*/
const TweenChooserButton = GObject.registerClass({    
...
/*const EffectChooserButton = new GObject.Class({
    ...
    Extends: BaseChooserButton,*/
const EffectChooserButton = GObject.registerClass({    
    ...
    class EffectChooserButton extends BaseChooserButton {
        ...
        build_menuitem(effect_type, col, row) {
