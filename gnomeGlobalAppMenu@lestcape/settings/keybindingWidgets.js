...
const ButtonKeybinding = GObject.registerClass({    
    ...
    class ButtonKeybinding extends Gtk.TreeView {
        ...
        on_cell_edited(cell, path, accel_string, accel_label) {
            this.accel_string = accel_string;
            this.emit("accel-edited", accel_string, accel_label);
            this.load_model();
        }

        on_cell_cleared(cell, path) {
            this.accel_string = "";
            this.emit("accel-cleared");
            this.load_model();
        }

        on_focus_lost(widget, event) {
...
const CellRendererKeybinding = GObject.registerClass({    
