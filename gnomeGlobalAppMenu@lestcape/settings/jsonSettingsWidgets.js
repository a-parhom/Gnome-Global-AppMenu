...
const JSONSettingsHandler = GObject.registerClass({
    ...
    class JSONSettingsHandler extends GObject.Object {
        ...
        bind(key, obj, prop, direction, map_get, map_set) {//map_get=null, map_set=null
        ...
        object_value_changed(obj, value, key) {
...
function json_settings_factory(subclass) {
    ...
    const JSONSettingsBackend = GObject.registerClass({
            GTypeName: 'ClassicGnomeJSONSettingsBackend'+subclass
        },

        class JSONSettingsBackend extends eval('SettingsWidgets.' + subclass) {
            _init(key, settings, properties) {
                this.key = key;
