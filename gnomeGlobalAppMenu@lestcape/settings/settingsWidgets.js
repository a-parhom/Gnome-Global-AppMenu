...
var SettingsPage = GObject.registerClass({    
    ...
    class SettingsPage extends Gtk.Box {
        ...
        add_reveal_section(title, schema, key, values) {//title, schema=null, key=null, values=null
            let section = new SettingsBox(title);
...
var SettingsBox = GObject.registerClass({    
    ...
    class SettingsBox extends Gtk.Frame {
        ...
        add_reveal_row(widget, schema, key, values) {//widget, schema=null, key=null, values=null
            let vbox = new Gtk.Box({ orientation: Gtk.Orientation.VERTICAL });
            if (this.need_separator) {
                vbox.add(new Gtk.Separator({ orientation: Gtk.Orientation.HORIZONTAL }));
            }
...
var SpinButton = GObject.registerClass({    
    ...
    class SpinButton extends SettingsWidget {
        _init(params) {
...
var Entry = GObject.registerClass({    
    ...
    class Entry extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
...
var TextView = GObject.registerClass({    
    ...
    class TextView extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
...
var FontButton = GObject.registerClass({    
    ...
    class FontButton extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
...
var Range = GObject.registerClass({    
    ...
    class Range extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
...
var ComboBox = GObject.registerClass({    
    ...
    class ComboBox extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
...
var ColorChooser = GObject.registerClass({    
    ...
    class ColorChooser extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
...
var FileChooser = GObject.registerClass({    
    ...
    class FileChooser extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
...
var SoundFileChooser = GObject.registerClass({    
    ...
    class SoundFileChooser extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
                label: "", size_group: null, dep_key: null, tooltip: ""
            });
        ...
        on_play_clicked(widget) {
            global.play_sound_file(0, this.get_value(), "", null);
        }

        on_picker_clicked(widget) {
        ...
        update_button_label(absolute_path) {
...
var IconChooser = GObject.registerClass({    
    ...
    class IconChooser extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
                label: "", expand_width: false, size_group: null, dep_key: null, tooltip: ""
            });
        ...
        update_icon_preview_cb(dialog, preview) {
...
var TweenChooser = GObject.registerClass({    
    ...
    class TweenChooser extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
                label: "", size_group: null, dep_key: null, tooltip:""
            });
...
var EffectChooser = GObject.registerClass({    
    ...
    class EffectChooser extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
...
var DateChooser = GObject.registerClass({    
    ...
    class DateChooser extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
                label: "", size_group: null, dep_key: null, tooltip: ""
            });
...
var Keybinding = GObject.registerClass({    
    ...
    class Keybinding extends SettingsWidget {
        _init(params) {
            params = Params.parse(params, {
